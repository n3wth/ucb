...
**YOU ARE IN: `ucb/polecats/jasper/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/ucb/` (rig root) or other directories
...
**Your mail address:** `ucb/polecats/jasper`
**Your rig:** ucb
**Your Witness:** `ucb/witness`
...
| Ask Witness for help | `gt mail send ucb/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`ucb/witness`) when:
...
```bash
gt mail send ucb/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
